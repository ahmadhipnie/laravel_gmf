        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add Last Inspection</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('store_last_inspection') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label>Last Know Condition </label>
                            <select name="last_know_condition" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="follow_up_action" class="form-control" required>
                                ...
                                <option value="further repair">further repair</option>
                                <option value="replacement">replacement</option>
                                <option value="re-inspection required">re-inspection required</option>
                            </select>
                        </div>

                        <button type="submit" class="btn btn-primary btn-block">Save Last Inspection</button>
