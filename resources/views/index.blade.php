  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      {{-- <a href="index.html" class="logo d-flex align-items-center"> --}}
        ...
        <img src="img/img_logo_garuda.png" alt="Logo" class="logo" width="30%"
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between">
          <div class="col-lg-4 order-lg-last hero-img" data-aos="zoom-out" data-aos-delay="100">
            <img src="img/img_logo_garuda.png" class="img-fluid animated" alt="">
          </div>

          <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
            <h1>Sistem Informasi untuk Pelaporan <span>GMF</span></h1>
            <p>Segera Coba Fitur untuk mengetahui kondisi barang dengan scan QR</p>
            <div class="d-flex">
              <a href="" class="btn-get-started">Scan Sekarang</a>
